...
public class Main {
	      ...
	      public static void main(String[] args) {
		        // Questão 02: Crie um programa que faça vários cálculos
			...
			public static void calculadora() {
				...
				System.out.println("Qual é a operação matemática desejada? - digite um número de 1 a 4 para escolher: ");
				...
				case "3":
				case "divisao":
					System.out.println("O resultado da divisão  entre " + numeroA + " e " + numeroB + " é = " 
				...
				case "4":
				case "multiplicacao":
					System.out.println("O resultado da multiplicação entre " + numeroA + " e " + numeroB + " é = "
